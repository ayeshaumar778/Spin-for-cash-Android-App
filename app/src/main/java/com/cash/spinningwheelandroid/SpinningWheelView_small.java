...
public class SpinningWheelView_small extends View implements WheelRotation.RotationListener {
    ...
    public SpinningWheelView_small(Context context) {
        super(context);
    }

    public SpinningWheelView_small(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public SpinningWheelView_small(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SpinningWheelView_small(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
